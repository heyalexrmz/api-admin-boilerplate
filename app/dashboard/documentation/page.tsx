...
const createTicketFields = [
  ...
  },
  {
    ...
    type: "string",
    description: "Razón social para persona moral o nombre fiscal completo para persona física.",
  },
  {
    name: "firstname",
    location: "json body",
    requirement: "Condicional",
    type: "string",
    description: "Nombre(s) para persona física. Puede omitirse o enviarse null para persona moral.",
  },
  {
    name: "lastname",
    location: "json body",
    requirement: "Condicional",
    type: "string",
    description: "Primer apellido para persona física. Puede omitirse o enviarse null para persona moral.",
  },
  {
    ...
    type: "string",
    description: "Segundo apellido para persona física. Puede omitirse o enviarse null para persona moral.",
  },
  {
    name: "file",
    location: "json body",
